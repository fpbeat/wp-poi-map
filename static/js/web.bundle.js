var wpPoiMap = (function () {
	...
	*/
	...
	var setProperty = function setProperty(target, options) {
		if (defineProperty$5 && options.name === '__proto__') {
			defineProperty$5(target, options.name, {
				enumerable: true,
				configurable: true,
	...
	var ObjectUtil = {
	  ...
	  pick: function pick(keys, obj) {
	    return keys.reduce(function (a, c) {
	      ...
	      return Object.assign({}, a, (_Object$assign = {}, _Object$assign[c] = obj[c], _Object$assign));
	    }, {});
	  },
	...
	var ElementUtil = {
	  ...
	  parseElements: function parseElements(container, selectors) {
	    var result = {};

	    var parser = function parser(values) {
	      if (values.length === 0) {
	        return null;
	      }
	    ...
	    for (var _i3 = 0, _Object$entries2 = Object.entries(selectors); _i3 < _Object$entries2.length; _i3++) {
	...
	var _default = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  _proto.getCenter = function getCenter() {
	    var center = String(this.options.settings['mapCenter'] || this.options.map.center);
	    var parts = center.split(',');

	    if (parts.length === 2) {
	      return _construct(google.maps.LatLng, parts.map(parseFloat));
	    }
	  ...
	  _proto.setObjectCenter = function setObjectCenter() {
	  ...
	  _proto.fitAllObjects = function fitAllObjects() {
	    var bounds = new window.google.maps.LatLngBounds();
	    this.markers.forEach(function (param) {
	      bounds.extend(param.instance.getPosition());
	    });
	    bounds.isEmpty() || this.map.fitBounds(bounds);
	  };

	  _proto.setInfoContent = function setInfoContent(template, marker) {
	    marker.setAnimation(null);
	    this.infoWindow.setContent("<div class=\"" + this.options.classes.template + "\">" + template + "</div>");
	    this.infoWindow.open(this.map, marker);
	  };

	  _proto.makeCurrentBounced = function makeCurrentBounced() {
	  ...
	  _proto.toggleVisibility = function toggleVisibility() {
	    var types = this.getCheckedTypes();
	    this.markers.forEach(function (param) {
	      var visible = types.includes(param.type);
	...
	var _default$1 = /*#__PURE__*/function (_EventEmitter) {
	  ...
	  _proto.createCallback = function createCallback() {
	    var funcName = 'gmap_' + StringUtil.uuid();
	...
	var _default$2 = /*#__PURE__*/function () {
	  ...
	  _proto.loading = function loading() {
	...
	var _default$3 = axios;
	axios_1.default = _default$3;

	var axios$1 = axios_1;

	var _default$4 = /*#__PURE__*/function (_Gmap) {
	  _inheritsLoose(_default, _Gmap);
	  ...
	  _proto.bootstrap = function bootstrap(container) {
	    ...
	    for (var _i = 0, _Object$values = Object.values(this.elements.types); _i < _Object$values.length; _i++) {
	      var element = _Object$values[_i];
	      element.addEventListener('change', this.update.bind(this));
	    }
	  };

	  _proto.getCheckedTypes = function getCheckedTypes() {
	    var types = [];

	    for (var _i2 = 0, _Object$entries = Object.entries(this.elements.types); _i2 < _Object$entries.length; _i2++) {
	      var _Object$entries$_i = _Object$entries[_i2],
	          name = _Object$entries$_i[0],
	  ...
	  _proto.start = function start() {
	    ...
	    this.status = new _default$2(this.elements.canvas, Object.assign({}, {
	  ...
	  _proto.loadData = function loadData() {
	    ...
	    axios$1({
	      ...
	      if (response.status === 200 && response.data) {
	        return _this2.process(response.data);
	      }
	...
	var web = {
	  version: '1.0.1',
	  builder: function builder(container, options) {
	    return new _default$4(container, options);
	  }
	};
